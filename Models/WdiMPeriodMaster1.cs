...
public partial class WdiMPeriodMaster1
{
    ...
    public virtual WdiMPartner1 Partner { get; set; } = null!;

    public virtual WdiTPeriodConfig1 PeriodConfigIdFkNavigation { get; set; } = null!;
}
