...
public partial class ImRepairAndMaintenanceDetail
{
    public long Id { get; set; }

    public string RepairItemId { get; set; } = null!;
    ...
    public virtual ImRepairAndMaintenanceMaster Repair { get; set; } = null!;
}
