...
public partial class ImItemsReceivedStock1
{
    ...
    public virtual ImGrnmaster1 Grn { get; set; } = null!;

    public virtual ImItemmaster1 Item { get; set; } = null!;

    public virtual ImPurchaseOrderMaster1 PurchaseOrder { get; set; } = null!;
}
