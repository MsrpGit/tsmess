...
public partial class UcLmLeavesEligibilityForUser3
{
    ...
    public virtual UcLmMLeavesEligibility3 LeaveEligibility { get; set; } = null!;

    public virtual UcLmMLeaveType3 LeaveType { get; set; } = null!;

    public virtual WdiMRolemaster3 Role { get; set; } = null!;
}
