...
public partial class WdiTIcseexamSchedule1
{
    ...
    public bool Addinfinalresult { get; set; }
    ...
    /// <summary>
    /// If language type is 1 it is first laguage 2 means second language 3 means third language.if it is 0 it is not language
    /// </summary>
