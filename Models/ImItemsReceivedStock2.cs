...
public partial class ImItemsReceivedStock2
{
    ...
    public virtual ImGrnmaster2 Grn { get; set; } = null!;

    public virtual ImItemmaster2 Item { get; set; } = null!;

    public virtual ImPurchaseOrderMaster2 PurchaseOrder { get; set; } = null!;
}
