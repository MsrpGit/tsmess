...
public partial class WdiTEnquire5
{
    ...
    public string? Counseledby2 { get; set; }

    public string? Enqremarks2 { get; set; }

    public string? Counseledby3 { get; set; }

    public string? Enqremarks3 { get; set; }
}
