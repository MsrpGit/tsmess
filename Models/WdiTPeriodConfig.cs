...
public partial class WdiTPeriodConfig
{
    ...
    public virtual WdiTTimeTableConfig TimeTableConfigIdFkNavigation { get; set; } = null!;

    public virtual ICollection<WdiMPeriodMaster> WdiMPeriodMasters { get; set; } = new List<WdiMPeriodMaster>();

    public virtual ICollection<WdiTBreak> WdiTBreaks { get; set; } = new List<WdiTBreak>();
}
