...
public partial class UcLmLeavesEligibilityForUser
{
    ...
    public virtual UcLmMLeavesEligibility LeaveEligibility { get; set; } = null!;

    public virtual UcLmMLeaveType LeaveType { get; set; } = null!;

    public virtual WdiMRolemaster Role { get; set; } = null!;
}
