...
public partial class WdiTFeePayment5
{
    ...
    public string? FeeCancelledBy { get; set; }
    ...
    public string? ReceiptNumberType { get; set; }

    public decimal ChequeBounce { get; set; }

    public string ChQstatus { get; set; } = null!;

    public byte AcPostingStatus { get; set; }
