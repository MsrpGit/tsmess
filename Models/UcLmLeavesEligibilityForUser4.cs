...
public partial class UcLmLeavesEligibilityForUser4
{
    ...
    public virtual UcLmMLeavesEligibility4 LeaveEligibility { get; set; } = null!;

    public virtual UcLmMLeaveType4 LeaveType { get; set; } = null!;

    public virtual WdiMRolemaster6 Role { get; set; } = null!;
}
