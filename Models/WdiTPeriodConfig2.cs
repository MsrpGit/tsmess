...
public partial class WdiTPeriodConfig2
{
    ...
    public virtual WdiTTimeTableConfig2 TimeTableConfigIdFkNavigation { get; set; } = null!;

    public virtual ICollection<WdiMPeriodMaster2> WdiMPeriodMaster2s { get; set; } = new List<WdiMPeriodMaster2>();

    public virtual ICollection<WdiTBreak2> WdiTBreak2s { get; set; } = new List<WdiTBreak2>();
}
